      ...
      <AnimatePresence initial={false}>
        {show && (
          <motion.button
            ...
            className="w-12 h-12 fixed bottom-6 right-4 z-10 flex items-center justify-center bg-white/30 border-2 border-gray-300/50 rounded-full backdrop-blur-md"
            onClick={scrollToTop}
          >
            <UpArrowIcon />
          </motion.button>
